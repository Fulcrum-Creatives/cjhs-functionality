 ...
 * Custom Taxonomies
 */
class CJHS_register_Taxonomies {
    /**
     * Class Constructor
     * 
     * @since     1.0.0
    ...
    public function __construct() {
        add_action( 'init', array( $this, 'register_awards_type_tax' ) );
        add_action( 'init', array( $this, 'register_web_sponsor_tax' ) );
    }
    /**
     * Register Awards Taxonomy
     */
    public function register_awards_type_tax() {
        $labels = array(
     ...
     */
    public function register_web_sponsor_tax() {
        $labels = array(
